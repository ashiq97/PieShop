    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> EditUser(EditUserViewModel editUserViewModel)
        {
            ...
            if (user != null)
            {
                ...
                ModelState.AddModelError("", "User not Updated,somthing went wrong");
        ...
        public IActionResult RoleManagement() // it is like index page where all list of roles are showed
        {
        ...
        public async Task<IActionResult> EditRole(string id)
        {
            ...
            var editRoleViewModel = new EditRoleViewModel
            {
                Id = role.Id,
                RoleName = role.Name,
                Users = new List<string>() // users that are already in that role
            };
        ...
        public async Task<IActionResult> EditRole(EditRoleViewModel editRoleViewModel)
        {
            ...
            if (role != null)
            {
                ...
                ModelState.AddModelError("", "Role Not Updated, somthing went wrong");
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            if (role != null)
            {
                ...
                if (result.Succeeded)
                    return RedirectToAction("RoleManagement", _roleManager.Roles);
                ModelState.AddModelError("", "Somthing went wrong while deleting this role");
            }
            else
            {
